    ...
    function getAllLocationsAndAddOffices() {
      ...
      request.onsuccess = function (event) {
        ...
        locations.forEach(function (location) {
          ...
          // Cambiar el icono del marcador de la ubicación del usuario
          if (location.description === "Ubicación actual del usuario") {
            var customUserIcon = L.divIcon({

                className: 'bi bi-geo',
              iconSize: [24, 24],
              iconAnchor: [12, 24],
            });
            marker.setIcon(customUserIcon);
          }
        });
